...
class Mesh:
    ...
    def load(cls, path=None, remesh=False, resize=True, renormal=True, retex=False, auto_uv=False, front_dir='+z', **kwargs):
        ...
        # obj supports face uv
            ...
            print(f"cls.load_obj took {toc - tic:0.4f} seconds")
        # trimesh only supports vertex uv, but can load more formats
        else:
            mesh = cls.load_trimesh(path, **kwargs)

        toc = time.perf_counter()
        print(f"Mesh loading took {toc - tic:0.4f} seconds")
        ...
        toc = time.perf_counter()
        print(f"Total mesh loading took {toc - tic:0.4f} seconds")
    ...
    def auto_normal(self):
        ...
        toc = time.perf_counter()
        print(f"auto normal took {toc - tic:0.4f} seconds")
